/**
 * Superior Doble - Ultra Elegante Carousel - FIXED VERSION
...
document.addEventListener('DOMContentLoaded', () => {
  try {
    console.log('Inicializando Superior Doble Carousel...');
