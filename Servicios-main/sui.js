/**
 * Suite Familiar - Ultra Elegante Carousel - FIXED VERSION
...
document.addEventListener('DOMContentLoaded', () => {
  try {
    console.log('Inicializando Suite Familiar Carousel...');
